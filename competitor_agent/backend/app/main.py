...
from app.config import validate_config, REPORT_DIR, PORT, HOST
...
# CORS 설정 (프론트엔드 접근 허용)
# 도커 환경 지원: 환경 변수 또는 기본값 사용
frontend_origins = os.getenv('FRONTEND_ORIGINS', 'http://localhost:30561').split(',')
app.add_middleware(
    CORSMiddleware,
